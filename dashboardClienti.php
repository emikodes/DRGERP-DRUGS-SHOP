                    ...
                    <div class="col p-5 min-vh-50">
                        <div class="d-flex justify-content-center">
                            <div class="card" style="width: 120rem">
                                <div class="card-body">
                                    <h5 class="card-title text-center mb-4">Elenco Clienti:</h5>

                                    <?php

                                    if ($queryPreparata = $connection->prepare("SELECT C.ID,C.Name,C.Surname,C.Address,C.PhoneNumber,C.email FROM customers C")) {
                                        ...
                                        if (!$queryPreparata->execute()) {
                                            ...
                                            if (count($risultatoQuery) == 0) {
                                                ...
                                                echo "<tr>";
                                                echo "<th>ID:</th><th>Nome:</th><th>Cognome:</th><th>Indirizzo:</th><th>Numero di telefono:</th><th>Email:</th><th>Operazioni:</th>";
                                                echo "</tr>";
                                                ...
                                                foreach ($risultatoQuery as $singolaTupla) {
                                                    ...
                                                    echo "<td>
                                                <form action=\"customer_edit.php\" method=\"POST\" class=\"d-inline\">
                                                    <button type=\"submit\" name=\"edit\" value=\"{$singolaTupla['ID']}\" class=\"btn btn-success btn-sm\">Edit</button>
                                                </form>
                                                <form action=\"customer_delete.php\" method=\"POST\" class=\"d-inline\">
